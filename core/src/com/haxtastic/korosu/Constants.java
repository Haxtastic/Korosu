...
public class Constants {
	...
	public class Layers {
		...
		public static final int PICKUPS = (1 << 4);
	}
	
	public class Masks {
		public static final int PLAYER = Constants.Layers.ENEMY | Constants.Layers.WALL | Constants.Layers.PICKUPS;
		...
		public static final int PICKUPS = Constants.Layers.PLAYER;
	}
