...
public class EntityFactory {
	...
	public static Entity createPlayer(World world, SimulationSystem sim, float x, float y) {
        ...
        actor.actor.setUserData((Object)e);
	...
	public static Entity createBullet(World world, SimulationSystem sim, float x, float y, float r, float speed, Bullet bullet) {
        ...
        Actor actor = new Actor(sim, position.x, position.y, BodyType.DynamicBody, true);
	...
	public static Entity createAmmo(World world, SimulationSystem sim, float x, float y, Ammo ammo) {
		Entity e = world.createEntity();
		...
		sprite.scaleX = 0.6f;
		sprite.scaleY = 0.3f;
		sprite.layer = Sprite.Layer.PICKUPS;
		e.addComponent(sprite);
        ...
        fd.friction = 0.5f;
        fd.isSensor = true;
        fd.filter.categoryBits = Constants.Layers.PICKUPS;
        fd.filter.maskBits = Constants.Masks.PICKUPS;
        ...
        // 4. Create the body fixture automatically by using the loader.
        loader.attachFixture(actor.actor, "ammo", fd, 0.6f, Constants.Layers.PICKUPS);
        actor.actor.setUserData((Object)e);
        
        e.addComponent(actor);
        
        world.getManager(GroupManager.class).add(e, Constants.Groups.AMMO);
		
		return e;
	}
	
	public static Entity createWeapon(World world, SimulationSystem sim, float x, float y, Weapon weapon) {
		Entity e = world.createEntity();
        ...
        // 4. Create the body fixture automatically by using the loader.
        loader.attachFixture(actor.actor, "weapon", fd, 0.6f, Constants.Layers.PICKUPS);
        actor.actor.setUserData((Object)e);
